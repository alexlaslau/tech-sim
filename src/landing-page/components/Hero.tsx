...
import { ToolUrl } from '../../shared/common';
        ...
        <div className='mx-auto max-w-8xl px-6 lg:px-8'>
          <div className='lg:mb-18 mx-auto max-w-3xl text-center'>
            <h1 className='text-4xl font-bold text-gray-900 sm:text-6xl dark:text-white'>
              Imagine <span className='italic'>minimizing risk</span> and making better decisions for your business...
            </h1>
            <p className='mt-6 mx-auto max-w-2xl text-lg leading-8 text-gray-600 dark:text-white'>
              Test and simulate business ideas before trying them on your actual business.
            </p>
            <div className='mt-10 flex items-center justify-center gap-x-6'>
              ...
              >
                Try the tool now <span aria-hidden='true'>→</span>
              </a>
            </div>
          </div>
